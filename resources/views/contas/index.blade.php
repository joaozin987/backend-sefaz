...
<body class="h-full w-full">
   ...
   <div class="text-center text-blue-700">
    ...
    <div class="flex w-full gap-8 overflow-hidden">
        ...
        <p class="text-xl-center ml-7 mr-7 text-orange-600 mt-16 font-semibold text-justify shadow-sm">O Parque Linear Freitas Neto, inaugurado pela Prefeitura de Maceió, está localizado na parte alta da cidade e tem como objetivo oferecer um novo espaço de lazer, esporte e convivência para a população. A obra faz parte do programa de requalificação urbana da região, transformando uma área antes subutilizada em um ambiente seguro e agradável. O parque conta com pistas de caminhada, ciclovias, academias ao ar livre, áreas de recreação infantil e paisagismo que valorizam o espaço. Além disso, há iluminação moderna e estruturas para garantir acessibilidade e conforto aos visitantes. Através de uma administração transparente e responsável, projetos como esse se tornam realidade, proporcionando moradia acessível para centenas de famílias. O trabalho da Secretaria envolve desde a arrecadação até a destinação correta dos recursos, sempre com foco no bem-estar dos cidadãos.</p>
    </div>
